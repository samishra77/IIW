...
public class AdapterWrapper implements IAdapterWrapper {
	...
	private void cliFetch(String community, Integer snmpVersion, String os, String vendor, DeviceDetailsWSResponse deviceDetailsResponse) {
		...
		if(adapter != null) {
			try {
				IDeviceDetailsResponse ddr = adapter.fetch(deviceDetailsResponse.getCircuitID(), deviceDetailsResponse.getDeviceIP(), snmpVersion, wanIP, community, null, null,null,null,null);
